...
--[[Vehicle Weight]]	
	...
	if mass<_Tune.Weight*weightScaling then
		...
		weightB.Parent = car:FindFirstChild('Main') or car:FindFirstChild('Body')
	end
...
--[[Finalize Chassis]]	
	...
	--Weld Body
	RS.Stepped:Wait()
	ModelWeld(car:FindFirstChild('Main') or car:FindFirstChild('Body'),car.DriveSeat)
