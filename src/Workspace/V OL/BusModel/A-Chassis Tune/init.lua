...
--[[Weight and CG]]
Tune.Weight			= 50000       -- Total weight (in pounds)
Tune.WeightBSize	= {			-- Size of weight brick (dimmensions in studs ; larger = more stable)
	--[[Width]]		11		,
	--[[Height]]		1		,
	--[[Length]]		50.8		}
Tune.WeightDist		= 48.5		-- Weight distribution (0 - on rear wheels, 100 - on front wheels, can be <0 or >100)48.5
Tune.CGHeight		= 10		-- Center of gravity height (studs relative to median of all wheels)
...
--Front Suspension
Tune.FSusDamping	= 2000	-- Spring Dampening
Tune.FSusStiffness	= 90000		-- Spring Force
Tune.FAntiRoll 		= 3000		-- Anti-Roll (Gyro Dampening)

Tune.FSusLength		= 3.7			-- Suspension length (in studs)
Tune.FPreCompress	= .3		-- Pre-compression adds resting length force
Tune.FExtensionLim	= 1.5		-- Max Extension Travel (in studs)
...
--Rear Suspension
Tune.RSusDamping	= 2000		-- Spring Dampening
Tune.RSusStiffness	= 90000		-- Spring Force
Tune.FAntiRoll 		= 3000	-- Anti-Roll (Gyro Dampening)

Tune.RSusLength		= 3.7			-- Suspension length (in studs)
Tune.RPreCompress	= .3		-- Pre-compression adds resting length force
Tune.RExtensionLim	= 1.5		-- Max Extension Travel (in studs)
...
Tune.SteerSpeed		= .025		-- Steering increment per tick (in degrees)
...
--Steer Gyro Tuning
Tune.SteerD			= 500		-- Steering Dampening
Tune.SteerMaxTorque	= 50000		-- Steering Force
Tune.SteerP			= 20000	-- Steering Aggressiveness

--[[Engine]]
--Torque Curve
Tune.Horsepower		= 7500		--	[TORQUE CURVE VISUAL]
...
Tune.Ratios			= {				-- Higher ratio = more torque, Lower ratio = higher top speed
	--[[Reverse]]	6.7		,	-- Copy and paste a ratio to add a gear
	--[[Neutral]]	0			,	-- Ratios can also be deleted
	--[[ 1 ]]		9.6		,	-- Reverse, Neutral, and 1st gear are required
	--[[ 2 ]]		4.9		,
	--[[ 3 ]]		3.27			,
	--[[ 4 ]]		2.8		,
	--[[ 5 ]]		2.46		,
...
Tune.FBrakeForce	= 6000		-- Front brake force
Tune.RBrakeForce	= 5500		-- Rear brake force
Tune.PBrakeForce	= 8500		-- Handbrake force
...
Tune.Controls = {
	...
	--Secondary Controls
	Throttle2				= Enum.KeyCode.Up					,
	Brake2					= Enum.KeyCode.Down					,
	SteerLeft2				= Enum.KeyCode.Left					,
	SteerRight2				= Enum.KeyCode.Right				,

	--Manual Transmission
	ShiftUp					= Enum.KeyCode.RightBracket			,
	ShiftDown				= Enum.KeyCode.LeftBracket			,
...
Tune.WeightScaling = .4/50	--Default = 1/50 (1 cubic stud = 50 lbs)
